    ...
    <div>
      ...
      <main>
        ...
        <p className="description">
          Click the button below, and view the sample error on the Sentry <a target="_blank" href="https://saas-application.sentry.io/issues/?project=4510477842186240">Issues Page</a>.
